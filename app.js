...
//Layout: es una vista predefinida por hbs que, por defecto, se va a mostrar SIEMPRE que rendericemos cualquier vista (index, players, teams...). Cuando rendericemos una vista, esta se va a sustituir por la parte que pone {{{body}}} del layout.